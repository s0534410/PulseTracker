    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                Button buttonConnected = (Button) findViewById(R.id.button_connect);
                buttonConnected.setText(R.string.disconnect);
                ...
                Button buttonConnected = (Button) findViewById(R.id.button_connect);
                buttonConnected.setText(R.string.connect);
...
//                displayGattServices(mBluetoothLeService.getSupportedGattServices());
                subscribeToHeartrateMeasurementCharacteristic();
        ...
        private void subscribeToHeartrateMeasurementCharacteristic() {

            UUID heartrateService = UUID.fromString("0000180d-0000-1000-8000-00805f9b34fb");
            BluetoothGattCharacteristic bluetoothGattCharacteristic = null;

            for (BluetoothGattService service : mBluetoothLeService.getSupportedGattServices()) {
                if (service.getUuid().equals(heartrateService)) {
                    bluetoothGattCharacteristic = service.getCharacteristic(UUID.fromString(SampleGattAttributes.HEART_RATE_MEASUREMENT));
...
//        getActionBar().setTitle(mDeviceName);
    ...
    protected void onResume() {
        ...
        if (mGattUpdateReceiver == null) {
            Log.d(TAG, "mGattUpdateReceiver is null");
        }
        ...
        if (mBluetoothLeService != null) {
            ...
            Log.d(TAG, "BluetoothLeService is null");
        }
    ...
    public void onButtonConnectedClick(View view) {
    ...
    private void displayGattServices(List<BluetoothGattService> gattServices) {
        if (gattServices == null) {
            Log.d(TAG, "no GATT services available");
            return;
        }

        Log.d(TAG, "GATT services available (num: " + gattServices.size() + ")");
